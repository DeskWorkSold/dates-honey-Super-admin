...
const CreateNotifictaion = () => {
  ...
  const [religonData, SetReligonData] = useState([
    {
      id: 1,
      value: 'label 1',
      name: 'label 1',
  ...
  const [EthinicityData, SetEthinicityData] = useState([
    {
      id: 1,
      value: 'label 1',
      name: 'label 1',
    ...
    <>
      <ScrollView
        ...
        <View style={{paddingHorizontal: 20, marginVertical: 20}}>
          ...
          <View style={{marginVertical: 10}}>
            <Select label="Religons" data={religonData} />
          </View>
          <View style={{marginVertical: 10}}>
            <Select label="Ethinicity" data={EthinicityData} />
          </View>
          <View
            style={{
              marginTop: 10,
...
export default CreateNotifictaion;
